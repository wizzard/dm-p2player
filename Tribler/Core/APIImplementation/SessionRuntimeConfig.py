...
class SessionRuntimeConfig(SessionConfigInterface):
    ...
    def get_tracker_send_predefseeds(self):
        self.sesslock.acquire()
        try:
            return SessionConfigInterface.get_tracker_send_predefseeds(self)
        finally:
            self.sesslock.release()
    ...
    def get_crawler_file(self):
        self.sesslock.acquire()
        try:
            return SessionConfigInterface.get_crawler_file(self)
        finally:
            self.sesslock.release()
    ...
    def get_votecast_recent_votes(self):
        self.sesslock.acquire()
        try:
            return SessionConfigInterface.get_votecast_recent_votes(self)
        finally:
            self.sesslock.release()
    ...
    def get_votecast_random_votes(self):
        self.sesslock.acquire()
        try:
            return SessionConfigInterface.get_votecast_random_votes(self)
        finally:
            self.sesslock.release()
    ...
    def get_channelcast(self,value):
        self.sesslock.acquire()
        try:
            return SessionConfigInterface.get_channelcast(self)
        finally:
            self.sesslock.release()
    ...
    def get_channelcast_recent_own_subscriptions(self):
        self.sesslock.acquire()
        try:
            return SessionConfigInterface.get_channelcast_recent_own_subscriptions(self)
        finally:
            self.sesslock.release()
    ...
    def get_channelcast_random_own_subscriptions(self):
        self.sesslock.acquire()
        try:
            return SessionConfigInterface.get_channelcast_random_own_subscriptions(self)
        finally:
            self.sesslock.release()
    ...
    def get_subtitles_collecting(self):
        self.sesslock.acquire()
        try:
            return SessionConfigInterface.get_subtitles_collecting(self)
        finally:
            self.sesslock.release()
