...
Section "!Main EXE" SecMain
 ...
 !define MozillaPlugin "Software\MozillaPlugins\@P2P-Next.org/${PRODUCTLC},version=${VERSION}"
 WriteRegStr HKLM ${MozillaPlugin} "Description" "${PRODUCT} for Mozilla Firefox"
 WriteRegStr HKLM ${MozillaPlugin} "Path" "$INSTDIR\npsp.dll"
 WriteRegStr HKLM ${MozillaPlugin} "Product" "${PRODUCT} P2P Multimedia Plug-in"
...
Function .onInit
  System::Call 'kernel32::CreateMutexA(i 0, i 0, t "${PRODUCT}") i .r1 ?e' 
