...
Download.prototype =
{
	...
	initialize: function( fragment, controller, data) 
	{
		...
		this._element._speeds_dl.innerHTML = this._dled + " / " + this._size + "  @  Download speed: " + this._DOWNspeed + " KB/s  |  Upload speed: " + this._UPspeed + " KB/s";
