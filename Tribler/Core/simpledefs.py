...
NTFY_NS_RICHMETADATA = 'nsrichmetadata' # NextShare XML RichMetadata
...
G2G_OFF = 0   # Give-to-Get disabled.
G2G_ON = 1    # Give-to-Get enabled for VoD and live.
G2G_AUTO = 2  # Give-to-Get enabled for VoD, not live.
