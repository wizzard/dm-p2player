...
class PluginEmulator:
    ...
    def __init__(self,port,cmd,param):
        ...
        #msg2 = "SETMOREINFO 620d5aa43bbf5f93b0debacaa24612e402ad641f 1\r\n";
        #s.send(msg2)
        ...
        while True:
            ...
            count += 1
            if count == 10:
                msg2 = "SETMOREINFO 620d5aa43bbf5f93b0debacaa24612e402ad641f 0\r\n";
                s.send(msg2)
            """
...
pe =  PluginEmulator(4567,"START","tswift://127.0.0.1:20001/89a18545fc5adb69ac1488852a70818a280b6fda$8192")
