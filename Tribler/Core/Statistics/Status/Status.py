...
NSPCLOG = True    # Logging in format as specified by ULANC for NSPC in 1 Feb 2011.
TRIALLOG = False  # Logging in free format for research trials.
...
class StatusHolder:
    ...
    Arno, 2011-03-24: a reporter must be added immediately after creation.
    Until that time, no events will be recorded.
    ...
    def __init__(self, name):
        ...
        self.elements = {}
        self.reporters = {}
        self.lock = threading.RLock() # Arno, prevent NullReporter deadlock
        self.events = []
    ...
    def add_event(self, event):
        self.lock.acquire()
        try:
            # Arno, 2011-03-24: Don't store events if there is no reporter,
            # this causes huge memory retention.
