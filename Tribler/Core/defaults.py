...
# M405 STBSPEEDCONFIG
sessdefaults['socket_write_always'] = False  # See SocketHandler
sessdefaults['socket_rcvbuf_size'] = None
sessdefaults['socket_sndbuf_size'] = None
...
# PREDEFSEEDS
trackerdefaults['tracker_send_predefseeds'] = False
...
# STBSPEED M405: Reconfigure to 2 ** 14 via API DownloadConfig.set_upload_unit_size()
...
# Version 4:
dldefaults['use_g2g'] = G2G_AUTO

# M405 STBSPEEDCONFIG: v5
dldefaults['live_drop_pieces'] = True
dldefaults['upload_while_prebuf'] = True
dldefaults['ratelim_min_resched_time'] = 0.0
dldefaults['socket_write_always'] = False
