...
class TestQueryReplyActive(TestAsServer):
    ...
    def tearDown(self):
        ...
        if self.failincallback:
            self.assertEquals("AssertionError","Was Thrown in usercallback")
    ...
    def pretest_userdef(self,keyword):
        self.pretest_q('USER',keyword)
    ...
    def query_usercallback(self,permid,query,hits):
        try:
            ...
            self.check_good_qreply(query,hits)
        except:
            self.failincallback = True
    ...
    #
    # Good user-defined QUERY
    #    
    def singtest_good_userdef_reply(self):
        self.pretest_userdef('hallo')
        self._test_qreply(self.create_good_userdef_reply,True)
    ...
    def create_good_userdef_reply(self,id):
        d = {}
        d['id'] = id
        d['a'] = 'goodbye' 
        b = bencode(d)
    ...
    def check_good_qreply(self,query,hits):
        if query.startswith('SIMPLE'):
            ...
            self.assertEquals(hits,"goodbye")
