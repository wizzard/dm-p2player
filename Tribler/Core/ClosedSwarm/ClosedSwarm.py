...
class ClosedSwarm:
    ...
    def a_check_poa_message(self, lst):
        ...
        """
        # Arno, 2010-12-13: test_both_valid calls a_provide_poa_message, which
        # was changed to set the state to COMPLETED immediately...
        #
        assert self.state == self.SEND_INITIATOR_RESPONSE or self.state == self.COMPLETED
        self.state = self.COMPLETED
