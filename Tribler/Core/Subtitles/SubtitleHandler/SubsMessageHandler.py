...
from Tribler.Core.Utilities.utilities import show_permid_short, validInfohash, validPermid, show_permid
    ...
    def _handleGETSUBS(self,permid, message, selversion):
        ...
        if DEBUG:
            ...
            print >> sys.stderr, "%s, %s, %s, %s, %d, %d" % ("RG", show_permid_short(permid), 
                                                     ...
                                                     show_permid(infohash), bitmask, len(message))
            ...
            if self._tokenBucket.consume(msgSize):
                ...
                if DEBUG:
                    ...
                    print >> sys.stderr, "%s, %s, %s, %s, %d, %d" % ("SS",show_permid_short(responseData['permid']),
                                                             ...
                                                             show_permid(responseData['infohash']),bitmask,int(msgSize*1024))
