...
class UserDefinedMaxAlwaysOtherwiseEquallyDividedRateManager(RateManager):
    ...
    def calc_and_set_speed_limits(self, dir = UPLOAD):
        ...
        if DEBUG:
            print >>sys.stderr,"RateManager: set_lim: len active workingset",len(workingset)
            ...
            if downloadsatmax and downloadsunderutil:
                ...
                for ds in todoset:
                    ...
                    if newmaxspeed < localmaxspeed:
                        ...
                        print >>sys.stderr,"RateManager: set_lim: Underutil set to",newmaxspeed
                ...
                if len(todoset2) > 0:
                    ...
                    for ds in todoset:
                        d = ds.get_download()
                        print >>sys.stderr,"RateManager: set_lim: Overutil set to",piece
                ...
                for ds in todoset:
                    d = ds.get_download()
                    print >>sys.stderr,"RateManager: set_lim: Normal set to",localmaxspeed
                    d.set_max_speed(dir,localmaxspeed)
