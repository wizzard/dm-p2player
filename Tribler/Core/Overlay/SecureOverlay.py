...
if LIBRARYNAME == "BaseLib":
    ...
    # discover, use different overlay infohash
    overlay_infohash = 'P2P-Next\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
else:
...
OLPROTO_VER_SIXTEENTH = 16 # 15th public release, QUERY messages with user-defined prefixes (NSPC 1.3.0 uses 15 here)

# Overlay-swarm protocol version numbers
OLPROTO_VER_CURRENT = OLPROTO_VER_SIXTEENTH
