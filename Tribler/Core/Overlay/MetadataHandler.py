...
from Tribler.Core.Utilities.utilities import isValidInfohash, show_permid_short, sort_dictlist, get_collected_torrent_filename
...
from Tribler.Core.CacheDB.SqliteCacheDBHandler import BarterCastDBHandler
from Tribler.Core.CacheDB.SqliteCacheDBHandler import PopularityDBHandler
from Tribler.Core.CacheDB.sqlitecachedb import bin2str # TODO
...
class MetadataHandler:
    ...
    def send_metadata_request(self, permid, infohash, selversion=-1, caller="BC"):
        if DEBUG:
            print >> sys.stderr,"metadata: send_meta_req: For",`infohash`
    ...
    def send_metadata(self, permid, message, selversion):
        ...
        if DEBUG:
            print >> sys.stderr,"metadata: send_meta: Remote peer wants",`infohash`
