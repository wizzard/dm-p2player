...
from Tribler.Core.Utilities.utilities import isValidPermid, show_permid, show_permid_short
...
#            assert isinstance(subSupp, SubtitlesSupport)
    ...
    def handleRMetadata(self, sender_permid, channelCastMessage, fromQuery = False):
        ...
        for md_and_have in metadataDTOs:
            ...
            vote = self.votecastDB.getVote(md.channel,self.my_permid)
                    ...
                    try:
                        ...
                        if DEBUG:
                            ...
                            print >> sys.stderr, "%s, %s, %s, %s, %d, %d" % \
                                (id, show_permid_short(metadataDTO.channel), \
                                show_permid(metadataDTO.infohash), \
