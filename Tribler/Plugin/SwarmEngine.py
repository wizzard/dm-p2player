...
from Tribler.Plugin.__init__ import PRODUCTNAME,VERSION
...
if __name__ == '__main__':
    run_bgapp(PRODUCTNAME,VERSION,I2I_LISTENPORT,BG_LISTENPORT,VIDEOHTTP_LISTENPORT,killonidle=False)
