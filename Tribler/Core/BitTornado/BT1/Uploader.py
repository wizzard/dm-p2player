...
from Tribler.Core.BitTornado.CurrentRateMeasure import Measure,TimeKeeper
...
class Upload:
    def __init__(self, connection, ratelimiter, totalup, choker, storage, 
                 picker, config, last_upload_time=TimeKeeper(0.0)):
        ...
        # Arno, 2011-02-16: accurate uploading detection
    ...
    def get_upload_chunk(self):
        ...
        self.last_upload_time.set(time.time())
