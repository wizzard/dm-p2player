...
class RawServer:
    def __init__(self, doneflag, timeout_check_interval, timeout, 
                 socketwritealways,socketrcvbufsize,socketsndbufsize,
                 noisy = True,
        ...
        if sockethandler is None:
            sockethandler = SocketHandler(timeout, ipv6_enable, socketwritealways, socketrcvbufsize, socketsndbufsize, READSIZE)
