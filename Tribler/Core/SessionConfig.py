...
class SessionConfigInterface:
    ...
    def set_overlay(self,value):
        ...
        (default = True). Megacache must be enabled as well.
        @param value Boolean. 
        """
    ...
    def set_dialback(self,value):
        """ Allow other peers to determine their external IP address via this 
    ...
    def get_dialback(self):
        """ Returns whether to allow DIALBACK_REQUESTs. 
        @return Boolean. """
    ...
    def set_dialback_active(self,value):
        ...
        @param value Boolean 
        """
        self.sessconfig['dialback_active'] = value

    def get_dialback_active(self):
        """ Returns whether to actively determine external IP via dialback 
        mechanism. 
        @return Boolean. """
        return self.sessconfig['dialback_active']
    ...
    # PREDEFSEEDS
    def set_tracker_send_predefseeds(self,value):
        """ Whether to send predefined seeders from TorrentDef.get_initial_peers()
        as the first value in a tracker reply.
        @param value Boolean.
        """
        self.sessconfig['tracker_send_predefseeds'] = value

    def get_tracker_send_predefseeds(self):
        """ Returns whether sending predefined seeders is enabled. 
        @return Boolean. """
        return self.sessconfig['tracker_send_predefseeds']
    ...
    def set_crawler_file(self,value):
        """ File with PermIDs of crawlers (default = install_dir+
        Tribler/Core/Statistics/crawler.txt).
        @param value An absolute path name.
        """
        self.sessconfig['crawler_file'] = value

    def get_crawler_file(self):
        """ Returns the crawler file.
        @return An absolute path name. """
        return self.sessconfig['crawler_file']
    ...
    # ChannelCast
    #
    def set_channelcast(self,value):
        """ Enabled/disable ChannelCast and VoteCast
        @param value Boolean
        """
        self.sessconfig['channelcast'] = value
    
    def get_channelcast(self,value):
        """ Returns whether ChannelCast and VoteCast are enabled.
        @return Boolean
        """
        return self.sessconfig['channelcast']
    ...
    # M405 STBSPEEDCONFIG
    #
    def set_socket_write_always(self,value):
        """ Enable or disable always writing data to socket immediately
        @param value Boolean
        """
        self.sessconfig['socket_write_always'] = value

    def get_socket_write_always(self):
        """ Returns whether immediate socket writing is enabled.
        @return Boolean
        """
        return self.sessconfig['socket_write_always']
    
    def set_socket_rcvbuf_size(self,value):
        """ Set SO_RCVBUF value for sockets, or None for default.
        @param value Integer
        """
        self.sessconfig['socket_rcvbuf_size'] = value

    def get_socket_rcvbuf_size(self):
        """ Returns SO_RCVBUF value for sockets.
        @return Integer
        """
        return self.sessconfig['socket_rcvbuf_size']
    
    def set_socket_sndbuf_size(self,value):
        """ Set SO_SNDBUF value for sockets, or None for default.
        @param value Integer
        """
        self.sessconfig['socket_sndbuf_size'] = value

    def get_socket_sndbuf_size(self):
        """ Returns SO_SNDBUF value for sockets.
        @return Integer
        """
        return self.sessconfig['socket_sndbuf_size']
