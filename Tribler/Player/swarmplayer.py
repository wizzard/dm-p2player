...
if sys.platform == "darwin":
    ...
    # Arno, 2010-11-02: breaking SwarmPlayer v1.
...
class PlayerApp(BaseApp):
    ...
    def start_video_frame(self):
        self.videoFrame = PlayerFrame(self,self.appname,self.appversion)
...
class PlayerFrame(VideoFrame):
    def __init__(self,parent,appname,appversion):
        VideoFrame.__init__(self,parent,parent.utility,appname+' '+appversion,parent.iconpath,parent.videoplayer.get_vlcwrap(),parent.logopath)
        self.parent = parent
        self.closed = False
...
if __name__ == '__main__':
    run_playerapp("SwarmPlayer","1.4.0")
