...
class SingleDownload:
    ...
    def __init__(self,infohash,metainfo,kvconfig,multihandler,get_extip_func,listenport,videoanalyserpath,vodfileindex,set_error_func,pstate,lmvodeventcallback,lmhashcheckcompletecallback):
        ...
        try:
            ...
            if pstate is not None:
                ...
                self.checkpointedstatus = pstate['dlstate']['status']
            else:
                self.hashcheckfrac = 0.0
                self.checkpointedstatus = None
            ...
            if vodfileindex is not None:
                ...
                if svc:
                    ...
                    self.videostatus = VideoStatus(metainfo['info']['piece length'],self.dow.files,vodfileindex,authparams,kvconfig)
    ...
    def get_checkpointedstatus(self):
        return self.checkpointedstatus
    ...
    def fatalerrorfunc(self,data):
        ...
        if type(data) == StringType:
            print >>sys.stderr,"SingleDownload: fatalerrorfunc: LEGACY CORE FATAL ERROR",data
            print >>sys.stderr,"SingleDownload: fatalerrorfunc: LEGACY CORE FATAL ERROR: stack is"
            print_stack()
